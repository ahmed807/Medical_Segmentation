...
RUN_NAME = "v4_arrow_tip_inverted_freeform_mask"
...
def create_run_dir() -> dict:
    ...
    with open(info_path, "w") as f:
        ...
        f.write(f"|---|---|\n")
        f.write(f"| arrow | Point prompt at tip (two-endpoint wide-end algorithm) |\n")
...
def find_arrow_tip(annot_np: np.ndarray, radius: int = 20):
    ...
    # Step 1: Find the two points furthest apart (arrow endpoints)
    ...
    # Step 2: Count annotation pixels near each endpoint
    ...
    # Step 3: Tip = the endpoint with MORE nearby pixels (arrowhead spread)
