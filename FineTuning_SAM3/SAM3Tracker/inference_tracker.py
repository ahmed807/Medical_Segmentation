...
def annotation_to_sam_prompt(annot_np: np.ndarray,
    ...
    if annotation_type == "arrow":
        ...
        # rect_bbox / freeform_bbox — annotation box IS the object region
...
def sam_predict(model, processor,
    ...
    try:
        ...
        # If point prompts fail, fall back to box
        print(f"  Point prompt failed ({e}), falling back to box prompt")
